...
##
## MTK_LELINK_ENABLE
## Brief:       This option is to enable jingdong cloud platform - lelink.
## Usage:       If the value is "y", the MTK_LELINK_ENABLE compile option will be defined. You must also include the middleware/third_party/cloud/lelink/module.mk in your Makefile before setting the option to "y". 
## Path:        middleware/third_party/cloud/lelink
## Dependency:  LWIP module.
##
ifeq ($(MTK_LELINK_ENABLE),y)
COM_CFLAGS += -DMTK_LELINK_ENABLE
endif
...
COM_CFLAGS += -DCFG_SUPPORT_SMNT_PROTO=6
endif
...
ifeq ($(MTK_LELINK_ENABLE),y)
MID_LELINK_PATH 	= $(SOURCE_DIR)/middleware/third_party/cloud/lelink
endif
