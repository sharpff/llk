...
#define FLASH_CM4_XIP_CODE_SIZE     0xAF000	      /* 700KB  */
// #define FLASH_TMP_SIZE              0xBF000       /* 764KB */
#define FLASH_TMP_SIZE              0xAF000	      /* 700KB  */
#define FLASH_USR_CONF_SIZE         0x5000        /*  20KB */
#define FLASH_EEPROM_SIZE           0x1000        /*  4KB */

#define FLASH_LELINK_CUST_SIZE      0x20000       /*  128KB */
...
#define CM4_FLASH_LELINK_CUST_ADDR  (CM4_FLASH_TMP_ADDR        + FLASH_TMP_SIZE) /* 0x1BA000 */
#define CM4_FLASH_USR_CONF_ADDR     (CM4_FLASH_LELINK_CUST_ADDR        + FLASH_LELINK_CUST_SIZE)
#define CM4_FLASH_EEPROM_ADDR       (CM4_FLASH_USR_CONF_ADDR   + FLASH_USR_CONF_SIZE)

#define GW_FLASH_CONF_SIZE 0x2000
