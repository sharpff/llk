...
do_copy "$MAIN_PATH/hal/$PF/halHeader.h" "$MTSDK7687/project/mt7687_hdk/apps/le_demo/inc/"
do_copy "$MAIN_PATH/hal/$PF/*.c" "$MTSDK7687/project/mt7687_hdk/apps/le_demo/hal/"
