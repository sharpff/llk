...
LOCAL_CFLAGS := -O2 -fexceptions -D__STDC_CONSTANT_MACROS=1 -D__LE_SDK__ -DTAG_LOG=\"LeLinkSo\" -DPF_VAL=4 -Dl_getlocaledecpoint=android_getlocaledecpoint -DLELINK_RELEASE
LOCAL_LDLIBS := -llog
