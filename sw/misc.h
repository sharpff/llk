...
#define JSON_NAME_EINT_TYPE         "type"
#define JSON_NAME_EINT_MODE         "mode"
#define JSON_NAME_EINT_TRIGGER      "trigger"
#define JSON_NAME_EINT_STATE        "state"
...
#define JSON_NAME_SDEV_CLU_IN       "cluI"
