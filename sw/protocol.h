...
typedef enum
{
    ...
    LELINK_SUBCMD_CTRL_SYNC_SLAVE_REQ,
    LELINK_SUBCMD_CTRL_SYNC_SLAVE_RSP,
    /*
    ...
    LELINK_SUBCMD_CLOUD_MSG_CTRL_C2R_SYNC_SLAVE_REQ,
    LELINK_SUBCMD_CLOUD_MSG_CTRL_C2R_SYNC_SLAVE_RSP,
    ...
    LELINK_SUBCMD_CLOUD_MSG_CTRL_R2T_SYNC_SLAVE_REQ,
    LELINK_SUBCMD_CLOUD_MSG_CTRL_R2T_SYNC_SLAVE_RSP,
