...
// #define MBEDTLS_PLATFORM_CALLOC_MACRO        calloc1 /**< Default allocator macro to use, can be undefined */
// #define MBEDTLS_PLATFORM_FREE_MACRO            free1 /**< Default free macro to use, can be undefined */
// #define MBEDTLS_PLATFORM_EXIT_MACRO            exit1 /**< Default exit macro to use, can be undefined */
// #define MBEDTLS_PLATFORM_FPRINTF_MACRO      fprintf1 /**< Default fprintf macro to use, can be undefined */
// #define MBEDTLS_PLATFORM_PRINTF_MACRO        printf1 /**< Default printf macro to use, can be undefined */
// /* Note: your snprintf must correclty zero-terminate the buffer! */
// #define MBEDTLS_PLATFORM_SNPRINTF_MACRO    snprintf1 /**< Default snprintf macro to use, can be undefined */
