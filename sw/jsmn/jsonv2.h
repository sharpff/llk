 ...
 * Applications are not supposed to define or use this structure
 */
typedef struct {
 ...
 */
int json_init(js_parser_t *jobj, jsontok_t *tokens, int num_tokens,
		char *js, int js_len);
 ...
 */
bool json_is_object(js_parser_t *jobj);
 ...
 */
bool json_is_array(js_parser_t *jobj);
/** Get JSON bool value
 *
 ...
 * \return -WM_E_JSON_FAIL if any other error was encountered.
 */
int json_get_val_bool(js_parser_t *jobj, char *key, bool *value);
 ...
 * \return -WM_E_JSON_FAIL if any other error was encountered.
 */
int json_get_val_int(js_parser_t *jobj, char *key, int *value);
 ...
 * \return -WM_E_JSON_FAIL if any other error was encountered.
 */
int json_get_val_int64(js_parser_t *jobj, char *key, int64_t *value);
 ...
 * \return -WM_E_JSON_FAIL if any other error was encountered.
 */
int json_get_val_float(js_parser_t *jobj, char *key, float *value);
 ...
 * \return -WM_E_JSON_FAIL if any other error was encountered.
 */
int json_get_val_str(js_parser_t *jobj, char *key, char *value, int max_len);
 ...
 * \return -WM_E_JSON_FAIL if any other error was encountered.
 */
int json_get_val_str_len(js_parser_t *jobj, char *key, int *len);
 ...
 * \return -WM_E_JSON_FAIL if any other error was encountered.
 */
int json_get_composite_object(js_parser_t *jobj, char *key);
 ...
 */
int json_release_composite_object(js_parser_t *jobj);
 ...
 * \return -WM_E_JSON_FAIL if any other error was encountered.
 */
int json_get_array_object(js_parser_t *jobj, char *key, int *num_elements);
 ...
 * \return -WM_E_JSON_FAIL if any error was encountered.
 */
int json_release_array_object(js_parser_t *jobj);
 ...
 */
int json_array_get_num_elements(js_parser_t *jobj);
 ...
 * \return -WM_E_JSON_FAIL if any other error was encountered.
 */
int json_array_get_bool(js_parser_t *jobj, uint16_t index, bool *value);
 ...
 * \return -WM_E_JSON_FAIL if any other error was encountered.
 */
int json_array_get_int(js_parser_t *jobj, uint16_t index, int *value);
 ...
 * \return -WM_E_JSON_FAIL if any other error was encountered.
 */
int json_array_get_int64(js_parser_t *jobj, uint16_t index, int64_t *value);
 ...
 * \return -WM_E_JSON_FAIL if any other error was encountered.
 */
int json_array_get_float(js_parser_t *jobj, uint16_t index, float *value);
 ...
 * \return -WM_E_JSON_FAIL if any other error was encountered.
 */
int json_array_get_str(js_parser_t *jobj, uint16_t index, char *value, int maxlen);
 ...
 * \return -WM_E_JSON_FAIL if any other error was encountered.
 */
int json_array_get_str_len(js_parser_t *jobj, uint16_t index, int *len);
 ...
 * \return -WM_E_JSON_FAIL if any other error was encountered.
 */
int json_array_get_composite_object(js_parser_t *jobj, uint16_t index);
 ...
 * \return -WM_E_JSON_FAIL if any error was encountered.
 */
int json_array_release_composite_object(js_parser_t *jobj);
 ...
 * \return -WM_E_JSON_FAIL if any other error was encountered.
 */
int json_array_get_array_object(js_parser_t *jobj, uint16_t index,
		int *num_elements);
 ...
 * \return -WM_E_JSON_FAIL if any error was encountered.
 */
int json_array_release_array_object(js_parser_t *jobj);
