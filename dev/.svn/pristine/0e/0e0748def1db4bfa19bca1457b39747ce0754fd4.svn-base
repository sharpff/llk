 ...
 */
void json_str_init(json_string_t *jptr, char *buff, int len);
 ...
 */
int json_start_object(json_string_t *jptr);
 ...
 * \return WM_SUCCESS if operation successful.
 */
int json_push_object(json_string_t *jptr, const char *name);
 ...
 * \return WM_SUCCESS if operation successful.
 */
int json_push_array_object(json_string_t *jptr, const char *name);
 ...
 * \return WM_SUCCESS if operation successful.
 */
int json_pop_array_object(json_string_t *jptr);
 ...
 * \return WM_SUCCESS if operation successful.
 */
int json_close_object(json_string_t *jptr);

int json_set_object_value(json_string_t *jptr, const char *name,
...
#define json_set_val_strobj(jptr, name, val, len) \
	json_set_object_value(jptr, name, val, len, 0.0, 0, \
	JSON_VAL_OBJ)
 ...
 * \return WM_SUCCESS if operation successful.
 */
int json_start_array(json_string_t *jptr);
 ...
 * \return WM_SUCCESS if operation successful.
 */
int json_close_array(json_string_t *jptr);

int json_cli_init(void);

int json_set_array_value(json_string_t *jptr, char *str, int value,
