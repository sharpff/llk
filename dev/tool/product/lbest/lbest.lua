...
function s1GetQueries()
    ...
    --local query = string.char( 0xA5, 0xA5, 0x5A, 0x5A, 0xA0, 0xC1, 0xEC, 0x03, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00)
	--local queryCountLen = string.char( string.len(query), 0x00 )
