...
function s2IsConditionOKExt(selfStatus, rmtStatus)
	...
	-- 	print('checking 1\r\n')
	-- 	if 1 == tblNewStatus["switcher"] and 1 ~= cmpValInOldStatus('10000100111000810008C80E77ABCD60', tblNewStatus["switcher"], "switcher") then
	...
	if nil ~= string.find(rmtUUID, '10000100101000010007C80E77ABCD50') then
		print('checking 1\r\n')
		if 1 == tblNewStatus["idx2"] and 0 ~= cmpValInOldStatus('10000100101000010007C80E77ABCD50', tblNewStatus["idx2"], "idx2") then
			tblConditions[retIdx] = 1
			print('ok 1\r\n')
		end
	else
		print('checking 2\r\n')
		if 0 == cmpValInOldStatus('10000100101000010007C80E77ABCD50', 1, "idx2") then
			tblConditionsOld[retIdx] = 1
			print('okOld 1\r\n')
		end
	end
