...
function s2IsConditionOKExt(selfStatus, rmtStatus)
	...
	-- -- 3.
	-- -- for single / multiple source AND
	-- toStoreStatus = 1
	-- local uuid1 = '10000100091000610006FFFFFFFFFFFF'
	-- local uuid2 = '10000100101000010007FFFFFFFFFFFF'
	-- local token1 = "percentage" -- 10000100091000610006FFFFFFFFFFFF
	-- local token2 = "idx3" -- 10000100101000010007FFFFFFFFFFFF
	-- local cmpVal1 = 100
	-- local cmpVal2 = 2
	-- local tblOldStatus = {}
	-- local ok1 = 0
	...
	-- local tblNewStatus = tblRmt["status"]
	-- if nil == tblNewStatus then
	-- 	print ('[LUA] s2IsConditionOKExt -e3\r\n')
	-- 	return ok
	-- end
	-- local newNodeVal1 = tblNewStatus[token1]
	-- local newNodeVal2 = tblNewStatus[token2]


	-- -- make sure it is a new status changed
	-- if nil == newNodeVal1 and nil == newNodeVal2 then
	-- 	print ('[LUA] s2IsConditionOKExt -e4\r\n')
	-- 	return ok
	-- end

	-- -- for every being reserved node's status checking
	-- if nil ~= string.find(rmtUUID, uuid1) then
	-- 	-- print('check 1\r\n')
	-- 	if cmpVal1 == newNodeVal1 and 0 ~= cmpValInOldStatus(uuid1, newNodeVal1, token1) then
	-- 		ok1 = 1
	-- 		print('ok1\r\n')
	-- 	end
	-- else
	-- 	-- print('check 11\r\n')
	-- 	if 0 == cmpValInOldStatus(uuid1, cmpVal1, token1) then
	-- 		okOld1 = 1
	-- 		print('okOld1\r\n')  
	-- 	end		
	-- end

	-- if nil ~= string.find(rmtUUID, uuid2) then
	-- 	-- print('check 2\r\n')
	-- 	if cmpVal2 == newNodeVal2 and 0 ~= cmpValInOldStatus(uuid2, newNodeVal2, token2) then
	-- 		print('ok2\r\n')  
	-- 		ok2 = 1
	-- 	end
	-- else
	-- 	-- print('check 22\r\n')
	-- 	if 0 == cmpValInOldStatus(uuid2, cmpVal2, token2) then
	-- 		print('okOld2\r\n')  
	-- 		okOld2 = 1
	-- 	end
	-- end

	-- if 1 == ok1 and 1 == okOld2 then
	-- 	ok = 1
	-- end
	-- if 1 == ok2 and 1 == okOld1 then
	-- 	ok = 1
	-- end


	-- 4. 
	-- for multiple source OR
	toStoreStatus = 1
	local uuid1 = '10000100091000610006FFFFFFFFFFFF'
	local uuid2 = '10000100101000010007FFFFFFFFFFFF'
	local token1 = "percentage" -- 10000100091000610006FFFFFFFFFFFF
