...
function getBeingReservedInfo()
	-- CUSTOMIZATION START
	local tblInfo = {'10000100101000010007C80E77ABCD50', '10000100111000810008C80E77ABCD60'}
	-- CUSTOMIZATION END
	return tblInfo
end
...
function s2IsConditionOKExt(selfStatus, rmtStatus)
	...
	if nil ~= string.find(rmtUUID, '10000100111000810008C80E77ABCD60') then
		print('checking 1\r\n')
		if 1 == tblNewStatus["switcher"] and 0 ~= cmpValInOldStatus('10000100111000810008C80E77ABCD60', tblNewStatus["switcher"], "switcher") then
			tblConditions[retIdx] = 1
			print('ok 1\r\n')
		end
	else
		print('checking 2\r\n')
		if 0 == cmpValInOldStatus('10000100111000810008C80E77ABCD60', 1, "switcher") then
	...
	if nil ~= string.find(rmtUUID, '10000100101000010007C80E77ABCD50') then
		print('checking 1\r\n')
		if 1 == tblNewStatus["idx3"] and 0 ~= cmpValInOldStatus('10000100101000010007C80E77ABCD50', tblNewStatus["idx3"], "idx3") then
			tblConditions[retIdx] = 1
			print('ok 1\r\n')
		end
	else
		print('checking 2\r\n')
		if 0 == cmpValInOldStatus('10000100101000010007C80E77ABCD50', 1, "idx3") then
			tblConditionsOld[retIdx] = 1
			print('okOld 1\r\n')
		end
	end
