...
function s2IsConditionOKExt(selfStatus, rmtStatus)
	...
	if nil ~= string.find(rmtUUID, '10000100101000010007F0B429000012') then
		print('checking 1\r\n')
		if 0 == tblNewStatus["idx4"] and 0 ~= cmpValInOldStatus('10000100101000010007F0B429000012', tblNewStatus["idx4"], "idx4") then
			tblConditions[retIdx] = 1
			print('ok 1\r\n')
		end
	else
		print('checking 2\r\n')
		if 0 == cmpValInOldStatus('10000100101000010007F0B429000012', 0, "idx4") then
			tblConditionsOld[retIdx] = 1
			print('okOld 1\r\n')
		end
	end
